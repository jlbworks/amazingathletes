...
vc_map( array(
		...
		"params" => array(
            ...
            array(
				...
				'save_always' => true,
                "dependency" => array('element' => "type", 'value' => array('masonry', 'justified_gallery'))
            ),
			array(
				"type" => "textfield",
				"holder" => "div",
            ...
            array(
                ...
                "dependency" => array('element' => 'type', 'value' => array('standard', 'standard_no_space', 'hover_text', 'hover_text_no_space', 'masonry', 'masonry_with_space','masonry_with_space_without_description', "justified_gallery"))
            ),
			array(
				"type" => "textfield",
				"holder" => "div",
			...
			array(
				...
				"description" => "",
				"dependency" => array('element' => "type", 'value' => array('standard','standard_no_space','hover_text','hover_text_no_space', 'masonry_with_space', 'masonry_with_space_without_description', 'justified_gallery'))
			),
			array(
				"type" => "textfield",
				"holder" => "div",
...
if(function_exists("is_woocommerce")) {
	...
	vc_map( 
		array(
			...
			"icon" => "icon-wpb-product_list_elegant",
			"category" => 'by QODE',
			"allowed_container_element" => 'vc_row',
			"params" => array(
				array(
...
vc_map( array(
    ...
    "icon" => "icon-wpb-social_share_list",
    "category" => 'by QODE',
    "allowed_container_element" => 'vc_row',
...
vc_map( array(
		...
		"category" => 'by QODE',
		"icon" => "icon-wpb-testimonials-masonry",
		"allowed_container_element" => 'vc_row',
		"params" => array(
			array(
				"type" => "textfield",
...
vc_map( array(
        ...
        'category' => 'by QODE',
        'icon' => 'icon-wpb-animation-holder',
        'allowed_container_element' => 'vc_row',
...
vc_map( array(
		...
		"icon" => "icon-wpb-animated_icon_with_text_item",
        "content_element" => true,
...
vc_map( array(
	...
	"content_element" => true,
	"icon" => "icon-wpb-pricing_list_item",
...
vc_map( array(
	...
	"content_element" => true,
	"category" => 'by QODE',
	"icon" => "icon-wpb-vertical_split_left",
	"show_settings_on_create" => false,
	"params" => array(),
	"js_view" => 'VcColumnView'
) );
...
vc_map( array(
	...
	"content_element" => true,
	"category" => 'by QODE',
	"icon" => "icon-wpb-vertical_split_right",
	"show_settings_on_create" => false,
	"params" => array(),
	"js_view" => 'VcColumnView'
) );
...
vc_map( array(
	...
	"content_element" => true,
	"category" => 'by QODE',
	"icon" => "icon-wpb-qode_horizontal_marquee_item",
	"show_settings_on_create" => true,
	"js_view" => 'VcColumnView',
	"params" => array(
		array(
...
vc_map( array(
	...
	"content_element" => true,
	"category" => 'by QODE',
	"icon" => "icon-wpb-qode_horizontal_marquee",
	"show_settings_on_create" => true,
	"params" => array(
		array(
			"type" => "textfield",
...
vc_map( array(
    ...
    "content_element" => true,
    "category" => 'by QODE',
    "icon" => "icon-wpb-qode_preview_slider",
    "show_settings_on_create" => false,
    "params" => array(),
    "js_view" => 'VcColumnView'
) );
...
vc_map( array(
    ...
    "category" => 'by QODE',
    "icon" => "icon-wpb-qode_preview_slider_item",
    "show_settings_on_create" => true,
    "params" => array(
        array(
            "type" => "attach_image",
