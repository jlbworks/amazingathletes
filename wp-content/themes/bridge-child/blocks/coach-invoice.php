...
/* Invoice data */
$total = '0.00';
if ( ! empty( $coach_invoice->total ) ) {
	$total = $coach_invoice->total;
}
$other = '0.00';
if ( ! empty( $coach_invoice->other ) ) {
	$other = $coach_invoice->other;
}
$notes = "";
if ( ! empty( $coach_invoice->notes ) ) {
	$notes = $coach_invoice->notes;
}
$travel_surcharge = '0.00';
if ( ! empty( $coach_invoice->travel_surcharge ) ) {
	$travel_surcharge = $coach_invoice->travel_surcharge;
}
$liability_insurance_rebate = '0.00';
if ( ! empty( $coach_invoice->liability_insurance_rebate ) ) {
	$liability_insurance_rebate = $coach_invoice->liability_insurance_rebate;
}
$equipment_rental_rebate = '0.00';
if ( ! empty( $coach_invoice->equipment_rental_rebate ) ) {
	$equipment_rental_rebate = $coach_invoice->equipment_rental_rebate;
}
$settled_outstanding_student_compensations = '0.00';
if ( ! empty( $coach_invoice->settled_outstanding_student_compensations ) ) {
	$settled_outstanding_student_compensations = $coach_invoice->settled_outstanding_student_compensations;
}
						...
						<div class="card-table">
							...
							<div class="card-inner">
								...
								<div class="col-12 clearfix">
									<h2>Invoice for:</h2>
									<p><?php echo date( 'F d, Y', strtotime( $coach_invoice->date_start ) ); ?>
										- <?php echo date( 'F d, Y', strtotime( $coach_invoice->date_end ) ); ?> </p>
								</div>
								<div class="col-12">
									<h2>Status</h2>
									<div class="form-group clearfix">
										<select name="status" class="form-control" id="status" title="Status" required>
											<option <?php if ( $coach_invoice->status == "pending" ) {
												echo "selected";
											} ?> value="pending">Pending
											</option>
											<option <?php if ( $coach_invoice->status == "paid" ) {
												echo "selected";
											} ?> value="paid">Paid
											</option>
										</select>
					...
					<div class="card-wrapper">
						...
						<div class="card-inner">
									...
									<div data-repeater-list="item">
										...
										<div data-repeater-item="">
											<div class="form-group clearfix">
												...
												<div class="col-16">
													<input type="text" name="item[0][quantity]" value="0"
													       class="form-control number js-quantity"
													       placeholder="Quantity">
												</div>

												<div class="col-16">
													<select name="item[0][quantity_type]" class="form-control"
													        id="item[0][quantity_type]"
													        title="Please select quantity type" required>
												...
												<div class="col-16">
													<input type="text" name="item[0][price]" value="0"
													       class="form-control currency js-add-to-total"
													       placeholder="Amount">
												</div>

												<div class="col-16">
													<input type="text" name="item[0][num_of_weeks]" value="1"
													       class="form-control number js-multiply-to-total"
													       placeholder="Amount">
												</div>
												...
												<div class="form-group clearfix">
													...
													<div class="col-16">
														<input type="text" name="item[0][description]"
														       class="form-control"
														       value="<?php echo $payment_total['description']; ?>"
														       placeholder="Description">
													</div>

													<div class="col-16">
														<input type="text" name="item[0][quantity]"
														       value="<?php echo $payment_total['quantity']; ?>"
														       class="form-control number js-quantity"
														       placeholder="Quantity">
													</div>
													...
													<div class="col-16">
														<select name="item[0][quantity_type]" class="form-control"
														        id="item[0][quantity_type]"
														        title="Please select quantity type" required>
															<option <?php if ( $payment_total['quantity_type'] == "students" ) {
																echo "selected";
															} ?> value="students">Students
															</option>
															<option <?php if ( $payment_total['quantity_type'] == "hours" ) {
																echo "selected";
															} ?> value="hours">Hours
															</option>
															<option <?php if ( $payment_total['quantity_type'] == "classes" ) {
																echo "selected";
													...
													<div class="col-16">
														<input type="text" name="item[0][price]"
														       value="<?php echo $payment_total['price']; ?>"
														       class="form-control currency js-add-to-total"
														       placeholder="Amount">
													</div>

													<div class="col-16">
														<input type="text" name="item[0][num_of_weeks]"
														       value="<?php echo $payment_total['num_of_weeks']; ?>"
														       class="form-control number js-multiply-to-total"
														       placeholder="Amount">
													</div>
										...
										<div class="form-group clearfix">
											<div class="col-14">
												<a class="left btn btn--primary" data-repeater-create=""><i
							...
							<div class="card-table frm_invoice_additional">
								<div class="card-table-row">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" id="js-total" data-js="" name="total"
												       class="form-control currency js-add-to-grand-total"
												       title="Please add bonus" value="$<?php echo $total; ?>"
												       readonly/>
											</fieldset>
										</div>
									</div>
								...
								<div class="card-table-row">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" data-js="" name="travel_surcharge"
												       class="form-control currency js-add-to-grand-total editable"
												       title="Please add travel surcharge"
												       value="$<?php echo $travel_surcharge; ?>"/>
											</fieldset>
										</div>
									</div>
								</div>
								<div class="card-table-row">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" data-js="" name="liability_insurance_rebate"
												       class="form-control currency js-add-to-grand-total editable"
												       title="Please add Liability Insurance Rebate"
												       value="$<?php echo $liability_insurance_rebate; ?>"/>
											</fieldset>
										</div>
									</div>
								</div>
								<div class="card-table-row">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" data-js="" name="equipment_rental_rebate"
												       class="form-control currency js-add-to-grand-total editable"
												       title="Please add bonus"
												       value="$<?php echo $equipment_rental_rebate; ?>"/>
											</fieldset>
										</div>
									</div>
								</div>
								<div class="card-table-row">
									<span
										class="card-table-cell fixed250">Settled Outstanding Student Compensations </span>
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" data-js=""
												       name="settled_outstanding_student_compensations"
												       class="form-control currency js-add-to-grand-total editable"
												       title="Please add Settled Outstanding Student Compensations"
												       value="$<?php echo $settled_outstanding_student_compensations; ?>"/>
											</fieldset>
										</div>
									</div>
								</div>
								<div class="card-table-row">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" data-js="" name="other"
												       class="form-control currency js-add-to-grand-total editable"
												       title="Please add Others" value="$<?php echo $other; ?>"/>
											</fieldset>
										</div>
									</div>
								</div>
								...
								<div class="card-table-row" style="color: red;">
									...
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
												<input type="text" id="js-grand-total" data-js="" name="grand_total"
												       class="form-control currency js-grand-total" title="Grand Total"
												       value="" readonly/>
											</fieldset>
										</div>
									</div>
								...
								<div class="card-table-row">
									<span class="card-table-cell fixed250"><strong>Notes</strong> </span>
									<div class="card-table-cell">
										<div class="card-form">
											<fieldset>
							...
							<div class="card-table-row clearfix">
								...
								<a class="left btn btn--transparent" style="margin-left:10px;"
								   href="<?php echo site_url(); ?>/invoice?type=coach&id=<?php echo $id; ?>"
								   type="submit" target="_blank">View Printable Invoice</a>
							</div>
							<div class="spacer"></div>
						</div>
