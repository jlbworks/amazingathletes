...
<form id="frm_user_account" action="<?php echo admin_url('admin-ajax.php') ?>" method="POST">
	...
	<input type="text" name="first_name" required maxlength="128" style="width: 98%;" value="<?=implode(" ", array(get_user_meta($user->ID,'first_name',true) )) ;?>"><br/>

	<label>Last name *</label>
	<input type="text" name="last_name" required maxlength="128" style="width: 98%;" value="<?=implode(" ", array(get_user_meta($user->ID,'last_name',true) )) ;?>"><br/>

	<label>Email Address *</label>
	<input type="text" name="email" required data-rule-email="true" maxlength="128" style="width:98%;" value="<?php echo $user->user_email ?>"><br/>
