...
<!--</div>-->
	...
	<script src="<?php bloginfo('stylesheet_directory'); ?>/assets_new/js/vendor/select2.js"></script>
	<!-- Custom Functions -->
	<script src="<?php bloginfo('stylesheet_directory'); ?>/assets_new/js/functions.js"></script>        
    <script src="<?php bloginfo('stylesheet_directory'); ?>/js-erp/functions.js"></script>
